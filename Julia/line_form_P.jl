...
# AlexPitertsev port of CogAlg to Julia, on Linux
# https://github.com/alex-pitertsev/CogAlg/blob/4ce0256d6a20a571d0e7243czdb0042d7037eee5d/line_1D_alg/julia/line_Ps_part.jl

# Twenkid's tests on Windows and timing, v. 14.7.2022: Dates etc.

using Images, ImageView, CSV, Dates
...
init_y = 1 #501  # starting row, set 0 for the whole frame, mostly not needed 
halt_y = 99999 #501  # ending row, set 999999999 for arbitrary image.
...
function scan()
	...
	#@timev line_Ps_root  #or @time -- when invoked from a file it returns nonsense:  0.000001 seconds
	#Dates.format(now(), "HH:MM:SS:MS")
	#@timevz line_Ps_root
