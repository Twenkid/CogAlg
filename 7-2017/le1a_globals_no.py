#d:\py\bk\le1a.py
#from 21/6/2017
# D:\Py\bk>python le1a.py
# Le1: 7.217298269271851

# D:\Py\bk>python le1a.py
# Le1: 7.197689056396484
#D:\Py\bk>python le1a.py
#Le1: 7.125969171524048
...
def init_globals():
    global vP_zero, dP_zero, fuzzy_zero;
    vP_zero = 0, 0, 0, 0, 0, 0, [], []  # tuple vP=0
    dP_zero = 0, 0, 0, 0, 0, 0, [], [] # tuple dP=0
    fuzzy_zero = 0, 0, 0, [], [] 
...
def inc_rng(a, aV, aD, min_r, A, AV, AD, r, p_):
	...
	#+ defined in an init function
	#global vP_zero = 0, 0, 0, 0, 0, 0, [], []  # tuple vP=0
	#global dp_zero = 0, 0, 0, 0, 0, 0, [], []  # tuple dP=0
	
    pri_s, I, D, V, rv, olp, p_, olp_ = vP_zero #0, 0, 0, 0, 0, 0, [], []  # tuple vP=0
    pri_sd, Id, Dd, Vd, rd, dolp, d_, dolp_ = dP_zero #0, 0, 0, 0, 0, 0, [], []  # tuple dP=0
	
    #pri_s, I, D, V, rv, olp, p_, olp_ = vP_zero # tuple vP=0
    #pri_sd, Id, Dd, Vd, rd, dolp, d_, dolp_ = dP_zero # tuple dP=0
...
def inc_der(a, aV, aD, min_r, A, AV, AD, r, d_):
    ...
    fd, fv, r, vP_, dP_ = 0, 0, 0, [], []  # r is initialized for each d_  #fuzzy_zero #
	 
    pri_s, I, D, V, rv, olp, p_, olp_ = 0, 0, 0, 0, 0, 0, [], []  # tuple vP=0,   vP_zero #
    pri_sd, Id, Dd, Vd, rd, dolp, d_, dolp_ = 0, 0, 0, 0, 0, 0, [], []  # tuple dP=0 dP_zero # 
...
def comp(p, pri_p, fd, fv, x, X,  # input variables
    ...
    if x > r+2 and (s != pri_s or x == X-1):  # if derived pri_s miss, vP is terminated
        ...
        I, D, V, rv, olp, dolp, p_, olp_ = vP_zero #0, 0, 0, 0, 0, 0, [], []  # initialization of new vP and olp
    ...
    if x > r+2 and (sd != pri_sd or x == X-1):  # if derived pri_sd miss, dP is terminated
        ...
        Id, Dd, Vd, rd, olp, dolp, d_, dolp_ = dP_zero #0, 0, 0, 0, 0, 0, [], []  # initialization of new dP and olp
